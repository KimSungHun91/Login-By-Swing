...
public class InfomationForm extends JDialog implements ActionListener {
	...
	public InfomationForm(LoginForm owner, User user) {
	...
	private void init() {
		...
		TitledBorder tBorder = new TitledBorder(new LineBorder(Color.GRAY, 1), "Check your Infomation");
	...
	private void logout() {
		int result = JOptionPane.showConfirmDialog(this, "logout : are you sure?", "Question",
	...
	private void withdraw() {
		int result = JOptionPane.showConfirmDialog(this, "do you really want to withdraw?", "Question",
				JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
		if (result == JOptionPane.YES_OPTION) {
			String password = JOptionPane.showInputDialog(this, "input your password", "check password",
